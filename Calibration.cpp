...
void CalibrationClass::init(OPERATION_TYPE operationType_) {
  ...
  if (operationType == SOURCE_VOLTAGE) {
    ...
    float_array_init(set_dac, dac_cal_points,   -500.00, -400.00, -300.00, -200.00, -100.00, 0.00, 10.00, 50.00, 100.00, 200.00, 300.00, 400.00, 500.00);
    float_array_init(meas_dac, dac_cal_points,  -500.00, -400.00, -300.00, -200.00, -100.00, 0.00, 10.00, 49.99, 099.96, 199.93, 299.97, 399.94, 500.00);
